...
<div class="banner_section layout_padding" data-aos="fade-up" style="margin-top: 80px; height: calc(100vh - 80px); position: relative;">
    <!-- Particle.js background -->
    <div id="particles-js" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; z-index: 0;"></div>

    <!-- Main content slider -->
    <div id="main_slider" class="carousel slide" data-ride="carousel" style="position: relative; z-index: 1; height: 100%;">
        <div class="carousel-inner" style="height: 100%;">
            <div class="carousel-item active" style="height: 100%; display: flex; align-items: center;">
                <div class="container text-center">
                    <h1 class="banner_taital">{{ $product->name }}</h1>
                    <p class="banner_text">{{ $product->part_no }} - {{ $product->process }}</p>
                    <div class="row" style="display: flex; justify-content: center; gap: 20px;">
                        <div class="read_bt"><a href="#spec">Lihat Detail</a></div>
                        <div class="read_bt"><a href="{{ route('login') }}">Login</a></div>
                    </div>
    ...
    <!-- background bg start -->
    <div class="background_bg" data-aos="fade-up" id="spec">
                        ...
                        <div class="col-md-6">
                            <div class="image_1">
                                @if($product->image)
                                    ...
                                    @else
                                        <p style="color: white !important">No image available</p>
                                    @endif
                                @else
                                    <p style="color: white !important">No image available</p>
                                @endif
                          ...
                          @if($product->parts->isNotEmpty())
                              <table class="table table-striped">
                                  <thead class="table-white" style="background-color: white !important">
                                      <tr>
                                          <th style="color: black !important">Item Part</th>
                                          <th style="color: black !important">Standart</th>
                                          <th style="color: black !important">Total Items Used</th>
                                      </tr>
                                  </thead>
